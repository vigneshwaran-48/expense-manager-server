...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.cors(Customizer.withDefaults()).sessionManagement()
                .sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().csrf().disable().authorizeHttpRequests(
                        http -> http.requestMatchers(HttpMethod.GET, Endpoints.GET_USER, Endpoints.GET_PERSONAL_STATS,
                                        Endpoints.LOGOUT)
                                ...
                                .requestMatchers(HttpMethod.GET, Endpoints.GET_FAMILY, Endpoints.GET_USER_FAMILY,
                                        ...
                                        Endpoints.GET_FAMILY_INVITATIONS, Endpoints.GET_FAMILY_SETTINGS,
                                        Endpoints.GET_FAMILY_STATS)
                                ...
                                .access(hasAnyScope("ExpenseManager.Family.Request.CREATE",
                                        "ExpenseManager.Family.ALL"))
                                .requestMatchers(HttpMethod.POST, Endpoints.FAMILY_ACCEPT_JOIN_REQUEST)
                                .access(hasAnyScope("ExpenseManager.Family.Request.ACCEPT",
                                        "ExpenseManager.Family.ALL"))
                                .requestMatchers(HttpMethod.POST, Endpoints.FAMILY_REJECT_JOIN_REQUEST)
                                .access(hasAnyScope("ExpenseManager.Family.Request.REJECT",
                                        "ExpenseManager.Family.ALL"))
                                ...
                                .requestMatchers(HttpMethod.POST, Endpoints.INVITE_MEMBER, Endpoints.RESEND_INVITATION,
                                        Endpoints.REVOKE_INVITATION)
                                ...
                                .access(hasAnyScope("ExpenseManager.StaticResource.READ",
                                        "ExpenseManager.StaticResource.ALL"))
                                ...
                                .access(hasAnyScope("ExpenseManager.Expense.DELETE", "ExpenseManager.Expense.ALL"))
